...
/*
La funcion convierte una cadena de minuscula a mayusculas
...
char *strstrmodificada(const char *cadena1, const char *cadena2) {
    ...
    while(*cadena1) {
        const char *carac1 = cadena1;
        const char *carac2 = cadena2;
        while(*carac2 && (*carac1 == *carac2)) {
            carac1++;
            carac2++;
        }
        if(*carac2 == '\0') {
